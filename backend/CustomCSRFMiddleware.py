...
class CustomCSRFMiddleware(CsrfViewMiddleware):
    ...
    def check_token_new(self, request):
        ...
        if request_csrf_token == "":
            ...
            try:
                ...
                request_csrf_token = request.COOKIES[settings.CSRF_COOKIE_NAME]
            except KeyError:
                raise RejectRequest(REASON_CSRF_TOKEN_MISSING)
            token_source = settings.CSRF_COOKIE_NAME
        else:
            token_source = "POST"
